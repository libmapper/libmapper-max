{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 280.0, 311.0, 740.0, 613.0 ],
		"bglocked" : 0,
		"defrect" : [ 280.0, 311.0, 740.0, 613.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 525.0, 90.0, 184.0, 18.0 ],
					"text" : "/disconnect /foo.1/out1 /foo.2/in1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 315.0, 297.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 240.0, 405.0, 41.0, 20.0 ],
					"text" : "print f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 405.0, 44.0, 20.0 ],
					"text" : "print e"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 405.0, 44.0, 20.0 ],
					"text" : "print d"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 30.0, 375.0, 229.0, 20.0 ],
					"text" : "mapper @alias foo @def tester.json"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 60.0, 36.0, 18.0 ],
					"text" : "/who"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 135.0, 137.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 375.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 405.0, 70.0, 20.0 ],
					"text" : "print admin"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 135.0, 44.0, 20.0 ],
					"text" : "print b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 135.0, 44.0, 20.0 ],
					"text" : "print a"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 114.5, 360.5, 39.5, 360.5 ],
					"source" : [ "obj-16", 0 ]
				}
